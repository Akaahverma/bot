...
BOT_TOKEN = "7192201715:AAHYOpZM5byTFA1NdMKcSqhs33p2G1eQjaA"
PAYMENT_CHANNEL = "@bot_payment123" #add payment channel here including the '@' sign
OWNER_ID = 6844347003 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@incometricks214","@JobfinderNo1"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
